...
function tt_temptt_register_required_plugins() {
	...
	$plugins = array(
		...
		// Including Webapp plugin
		array(
			'name'     				=> 'WebApp Plugin', // The plugin name
			'slug'     				=> 'webapp-plugin', // The plugin slug (typically the folder name)
			'source'   				=> $tt_plugins_paths . 'webapp-plugin.zip',
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
		...
		// Including Demo content plugin
		array(
			'name'     				=> 'WebApp Demo Content', // The plugin name
			'slug'     				=> 'webapp-demo-content', // The plugin slug (typically the folder name)
			'source'   				=> $tt_plugins_paths . 'webapp-demo-content.zip',
			'required' 				=> false, // If false, the plugin is only 'recommended' instead of required
	 ...
	 */
	$config = array(
		'id'           => 'webapp',                 // Unique ID for hashing notices for multiple instances of TGMPA.
